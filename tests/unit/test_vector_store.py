...
class TestVectorStore:
    ...
    def test_setup_persistent_chroma_existing_collection(self, mock_client_class, mock_embedding_model):
    ...
    @patch('src.vector_store.chromadb.PersistentClient')
    def test_setup_persistent_chroma_new_collection(self, mock_client_class, mock_embedding_model):
    ...
    def test_update_vector_database_new_file(self, mock_gen_id, mock_process_file, mock_chroma_collection):
        ...
        mock_process_file.return_value = [{
            ...
            'metadata': {'source_file': 'new_file.txt'}
        }]
