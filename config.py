...
DATA_DIRECTORY: str = "./data" # Contatins all company documents which will be processed
COMPANY_KNOWLEDGE_COLLECTION: str = "company_knowledge"
PERSISTENT_DB_PATH: str = "./chroma_db"  # Persistent database path
FILE_METADATA_PATH: str = "./file_metadata.json"  # File tracking metadata to update embeddings after a file is changed
MAX_TOKENS: int = 800 # Determines the lenghth of the response generated by the LLM
TEMPERATURE: float = 0 # Determines the creativity of the response generated by the LLM, 0 means deterministic, not creative at all
